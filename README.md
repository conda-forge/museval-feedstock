...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/museval-feedstock/blob/master/LICENSE.txt)
...
Once the `conda-forge` channel has been enabled, `museval` can be installed with:

```
conda install museval
```

It is possible to list all of the versions of `museval` available on your platform with:
